...
$channel->queue_declare(Constants::QUEUE2_NAME, false, false, false, false);
$channel->queue_bind(Constants::QUEUE2_NAME, Constants::EXCHANGE_NAME, Constants::ROUTING_KEY2);
...
$channel->basic_consume(Constants::QUEUE2_NAME, '', false, true, false, false, $callback);
