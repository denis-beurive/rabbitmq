...
$channel->queue_declare(Constants::QUEUE3_NAME, false, false, false, false);
$channel->queue_bind(Constants::QUEUE3_NAME, Constants::EXCHANGE_NAME, Constants::ROUTING_KEY3);
...
$channel->basic_consume(Constants::QUEUE3_NAME, '', false, true, false, false, $callback);
